...
<div class="main-content-inner">
            ...
            <div class="col-md-8 pull-left">
                <form method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="uid" value="<?php echo $uid; ?>" required> 
                                ...
                                <div class="form-gp">    
                                    <input type="text" name="industry" value="Rap" readonly> 
                                </div><br />
                                <div class="form-gp">    
    ...
    if(isset($_POST['upload']))
    {
        ...
        ?> 
    <script>
        window.alert("New Rap Song is uploaded successfully..!");
    ...
    <?php
        ...
        else
        {
         ?> 
    <script>
        window.alert("New Rap Song is not uploaded..!");
    window.location.href = window.location.href;
    </script>
    <?php   
        }
    ...
    ?>
            ...
            <div class="card mt-5">
                    <div class="card-body">
                        <h4 class="header-title">New Rap Song</h4>
                        <div class="table-responsive">
                            <table class="dbkit-table">
                                <tbody>
                                <?php
                    $res = mysqli_query($con, "SELECT COUNT(*) AS `count` FROM na_songs WHERE industry='Rap' AND uid='$uid'");
