...
<div class="main-content-inner">
                ...
                <div class="card mt-5">
                    <div class="card-body">
                        <h4 class="header-title">Punjabi Lyrics</h4>
                        <div class="table-responsive">
                            <table class="dbkit-table">
                                <tbody>
                                    ...
                                    <?php
                                    $gallery = mysqli_query($con,"SELECT * FROM lyrics WHERE language='Punjabi' order by id desc");
                    ...
                    <div class="col-md-8 pull-left">
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-gp">    
                                    <input type="text" name="language" value="Punjabi" readonly> 
                                </div><br />
                                <div class="form-gp">    
    ...
    if(isset($_POST['upload']))
    {
       ...
       $sql = mysqli_query($con,"INSERT INTO lyrics(id, title, link, credits, lyrics, video, language, trending, image, keywords, description, date) VALUES('','$title', '$link', '$credits', '$lyrics', '$video', '$lang', '$trend', '$image', '$key', '$desc', '$date')");
        ...
        ?> 
    <script>
        window.alert("Punjabi Song Lyric is uploaded successfully..!");
    ...
    <?php
        ...
        else
        {
         ?> 
    <script>
        window.alert("Punjabi Song Lyric is not uploaded..!");
    window.location.href = window.location.href;
    </script>
    <?php   
        }
