...
<div class="main-content-inner">
                ...
                <div class="card mt-5">
                    <div class="card-body">
                        <h4 class="header-title">Bollywood Lyrics</h4>
                        <div class="table-responsive">
                            <table class="dbkit-table">
                                <tbody>
                                    ...
                                    <?php
                                    $gallery = mysqli_query($con,"SELECT * FROM lyrics WHERE language='Bollywood' order by id desc");
                    ...
                    <div class="col-md-8 pull-left">
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-gp">    
                                    <input type="text" name="language" value="Bollywood" readonly> 
                                </div><br />
                                <div class="form-gp">    
    ...
    if(isset($_POST['upload']))
    {
       ...
       $title1 = $_POST['title'];
        ...
        ?> 
    <script>
        window.alert("Bollywood Song Lyric is uploaded successfully..!");
    ...
    <?php
        ...
        else
        {
         ?> 
    <script>
        window.alert("Bollywood Song Lyric is not uploaded..!");
    window.location.href = window.location.href;
    </script>
    <?php   
        }
