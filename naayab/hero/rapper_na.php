...
<div class="main-content-inner">
                ...
                <div class="card mt-5">
                    <div class="card-body">
                        <h4 class="header-title">Rapper New Artists</h4>
                        <div class="table-responsive">
                            <table class="dbkit-table">
                                <tbody>
                                    ...
                                    <?php
                                    $gallery = mysqli_query($con,"SELECT * FROM new_artists WHERE industry='Rapper' ORDER BY id DESC");
                    ...
                    <div class="col-md-8 pull-left">
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-gp">    
                                <input type="text" name="industry" value="Rapper" required>    
                                </div><br />
                                <div class="form-gp">    
