...
<div class="main-content-inner">
                ...
                <div class="card mt-5">
                    <div class="card-body">
                        <h4 class="header-title">English Lyrics</h4>
                        <div class="table-responsive">
                            <table class="dbkit-table">
                                <tbody>
                                    ...
                                    <?php
                                    $gallery = mysqli_query($con,"SELECT * FROM lyrics WHERE language='English' order by id desc");
    ...
    if(isset($_POST['upload']))
    {
        ...
        ?> 
    <script>
        window.alert("English Song Lyric is uploaded successfully..!");
    ...
    <?php
        ...
        else
        {
         ?> 
    <script>
        window.alert("English Song Lyric is not uploaded..!");
    window.location.href = window.location.href;
    </script>
    <?php   
        }
