...
<div class="main-content-inner">
        ...
        <div class="col-lg-12">
            <div class="col-md-8 pull-left">
                <form method="post" enctype="multipart/form-data">
                    <h4 class="title">Upload Punjabi Song:</h4><br>
                    <input type="hidden" name="uid" value="<?php echo $uid; ?>" required> 
                                ...
                                <div class="form-gp">    
                                    <input type="text" name="industry" value="Punjabi" readonly> 
                                </div><br />
                                <div class="form-gp">    
    ...
    if(isset($_POST['upload']))
    {
        ...
        ?> 
    <script>
        window.alert("New Punjabi Song is uploaded successfully..!");
    ...
    <?php
        ...
        else
        {
         ?> 
    <script>
        window.alert("New Punjabi Song is not uploaded..!");
    window.location.href = window.location.href;
    </script>
    <?php   
        }
    ...
    ?>
            ...
            <div class="card mt-5">
                    <div class="card-body">
                        <h4 class="header-title">New Punjabi Song</h4>
                        <div class="table-responsive">
                            <table class="dbkit-table">
                                <tbody>
                                <?php
                    $res = mysqli_query($con, "SELECT COUNT(*) AS `count` FROM na_songs WHERE industry='Punjabi' AND uid='$uid'");
                    $ros = mysqli_fetch_array($res);
                    ?>
                    <tr>
                    <td>Number Of Punjabi Songs: <?php echo $ros['count']; ?></td>
                                    ...
                                    <?php
                                    $gallery = mysqli_query($con,"SELECT * FROM na_songs WHERE industry='Punjabi' AND uid='$uid' order by id desc");
