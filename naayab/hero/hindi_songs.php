...
<div class="main-content-inner">
        ...
        <div class="col-lg-12">
            <div class="col-md-8 pull-left">
                <form method="post" enctype="multipart/form-data">
                    <h4 class="title">Upload Hindi Song:</h4><br>
                    ...
                    <div class="form-gp">
                        <input type="text" name="industry" value="Hindi" readonly>
                    </div><br />
                    <div class="form-gp">
                    ...
                    <div class="form-gp">
                        <textarea class="form-control" name="keywords" placeholder="Keywords" rows="4"
                            cols="3"></textarea>

                    </div><br />
                    <div class="form-gp">
                        <textarea class="form-control" name="description" placeholder="Description" rows="4"
                            cols="3"></textarea>
                    </div><br />
                    <div class="form-gp">
    ...
    if(isset($_POST['upload']))
    {
        ...
        ?>
        <script>
            window.alert("New Hindi Song is uploaded successfully..!");
        ...
        else
        {
         ?>
        <script>
            window.alert("New Hindi Song is not uploaded..!");
            window.location.href = window.location.href;
        </script>
        <?php   
        }
    ...
    <div class="card-body">
            <h4 class="header-title">New Hindi Song</h4>
            <div class="table-responsive">
                <table class="dbkit-table">
                    <tbody>
                    <?php
                    $res = mysqli_query($con, "SELECT COUNT(*) AS `count` FROM na_songs WHERE industry='Hindi' AND uid='$uid'");
                    $ros = mysqli_fetch_array($res);
                    ?>
                    <tr>
                    <td>Number Of Hindi Songs: <?php echo $ros['count']; ?></td>
                        ...
                        <?php
                                    $gallery = mysqli_query($con,"SELECT * FROM na_songs WHERE industry='Hindi' AND uid='$uid' order by id desc");
