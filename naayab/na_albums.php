...
$title = "Naayab.com : New Singers' Albums Songs";
$canonical = "https://www.naayab.com/na_albums";
include"header.php";
?>
    ...
    ============================-->
      ...
      <div class="container">
        <div class="section-header mt-5">
          <h1>New Singers Songs & Albums</h1>
          <h3>Large Collection of New Singers' Songs.</h3>
          <br />
        </div>
...
<hr />
        <div class="row">
          ...
          $res1 = mysqli_query($con, "SELECT * FROM {$statement} WHERE keywords like '%$key%' ORDER BY id DESC");
